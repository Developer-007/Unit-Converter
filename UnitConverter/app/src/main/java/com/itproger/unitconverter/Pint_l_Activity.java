...
public class Pint_l_Activity extends AppCompatActivity {
    TextView tview_unit1, tview_unit2, tview_enter_unit2;
    EditText eText;
    View v;
    RadioGroup radioGroup_pint_l;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pint_lactivity);
    }
    public void goBack_toVolume(View v) {
        Intent intent = new Intent(this, VolumeActivity.class);
        startActivity(intent);
    }
    public void pintTol_text(View v) {
        tview_unit1 = findViewById(R.id.unit_1);
        tview_unit2 = findViewById(R.id.unit_2);
        tview_unit1.setText("Пинты:");
        tview_unit2.setText("Л:");
    }

    public void lTopint_text(View v) {
        tview_unit1 = findViewById(R.id.unit_1);
        tview_unit2 = findViewById(R.id.unit_2);
        tview_unit1.setText("Л:");
        tview_unit2.setText("Пинты:");
    }
    public void countpint_l(View viev) {
        radioGroup_pint_l = findViewById(R.id.radio_group_pint_l);
        int checkButtonIndex = radioGroup_pint_l.getCheckedRadioButtonId();
        tview_unit1 = findViewById(R.id.unit_1);
        tview_unit2 = findViewById(R.id.unit_2);
    ...
    private void showErrorInfoSq(String text) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Pint_l_Activity.this);
